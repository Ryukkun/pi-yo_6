...
if __name__ == "__main__":
    coe = Coeiroink()
    coe.easy_synthesis(speaker=0, text="テストなのだ？")
    coe.easy_synthesis(speaker=11, text="テストなのだ？", out="./1.wav")
    _ = coe.audio_query(speaker=20, text="テストなのだ？")
    _.speedScale = 2.0
    coe.synthesis(query=_, speaker=20, out="./2.wav")
